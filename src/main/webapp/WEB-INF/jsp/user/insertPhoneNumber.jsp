		...
		<div class="row">
			<div class="col-sm-12 col-lg-6 offset-lg-3">
				<div class="login_form inner_page">
					<h4>"e다울마당" 서비스 연동</h4>
					<p>
						서비스에 연동하기 위해 전화번호를 입력해 주세요.
						<br>
						최초 한번만 입력하시면 됩니다.
					</p>
					<form id="connect-form" method="post">
						<div class="form-group">
							<input type="hidden" value="${userchannel_key}" name="userchannel_key">
							<input type="hidden" value="${forward}" id="forward">
							<input onkeyup="enterkey();" type="text" class="form-control" name="phone" id="phone_input" placeholder="전화번호">
						</div>
						<div class="form-group">
...
<script type="text/javascript">
	...
	function connect() {
		...
		var request = $.ajax({ url : "/user/connectKakao.do", method : "post",
