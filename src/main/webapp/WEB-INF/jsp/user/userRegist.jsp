				...
				<div class="reg-form-box">
					<form:form method="post" modelAttribute="userVo">
						...
						<div class="form-group row ">
							...
							<div class="col-lg-9">
								<form:checkbox class="form-control" value="Y" path="email_chk"/>
							</div>
						</div>
						<div class="form-group row ">
							<div class="col-lg-3 p0">
								<label>알림톡<span>*</span></label>
							</div>
							<div class="col-lg-9">
								<form:checkbox class="form-control" value="Y" path="talk_chk"/>
							</div>
						</div>
						<div class="form-group row ">
							<div class="col-lg-3 p0">
								<label>SMS<span>*</span></label>
							</div>
							<div class="col-lg-9">
								<form:checkbox class="form-control" value="Y" path="sms_chk"/>
							</div>
						</div>
