...
<script type="text/javascript">
	...
	if (pathname.indexOf("main") > -1) {
		...
		var div = '<div class="container">' + '<div class="row posr">' + '<div class="col-lg-10 offset-lg-1">' + '<div class="home_content home7">'
				+ '<div class="home-text text-center">'
				+ '<h2 class="fz55 ">시민 참여 소통 플랫폼 <span class="focus-text">e-다울마당</span><br>여러문의 목소리가 전주시를 바꾸는 정책이 됩니다.</h2>'
				+ '<button type="button" class="btn btn-lg btn-thm banner-btn" onclick="goSuggestionRegist()">제안하기</button>' + '</div>' + '</div>'
				+ '</div>' + '</div>' + '</div>';
		...
		var div = '<div class="container">' + '<div class="breadcrumb_content">' + '<h4 class="breadcrumb_title">사용자</h4>' + '</div>' + '</div>';
