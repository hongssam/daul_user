				...
				<div class="board-detail-table edit-style">
					...
					<div class="table-responsive mt0">
						<form:form method="post" modelAttribute="qnaVo">
							<form:input type="hidden" class="form-control" placeholder="" path="qna_idx"/>
							<table class="table">
								<tbody>
									<tr>
							...
							<div class="board-btns text-center">
								<button type="submit" class="btn btn-primary" id="qnaUpdateBtn" data-title="묻고답하기" formaction="/qna/qnaUpdate.do">수정</button>
